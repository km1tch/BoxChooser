...
variable, or defaults to: BoxChooser/db/packing.db
"""
...
def init_db():
    ...
    with get_db() as db:
        ...
        if 'notification_url' not in columns:
            db.execute('ALTER TABLE superadmins ADD COLUMN notification_url TEXT')
        ...
        if not existing_demo:
            ...
            logger.info("Demo store (999999) created with PIN: 123456")
